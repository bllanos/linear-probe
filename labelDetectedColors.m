...
if isOnBothSidesOfLine(...
        {[border_points(1, :); line_endpoints(1, 1:2)]},...
        [border_points(4, :); line_endpoints(4, 1:2)]...
    )
...
if isOnBothSidesOfLine(...
        {[border_points(2, :); line_endpoints(2, 1:2)]},...
        [border_points(3, :); line_endpoints(3, 1:2)]...
    )
    intersection_point = cross(...
